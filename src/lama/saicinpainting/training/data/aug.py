# Mock implementation for inference-only usage
# Original implementation requires albumentations < 1.1 with imgaug which is hard to install
...
try:
    ...
    # Fallback for inference-only usage - these classes are only needed for training
    ...
    class IAAAffine2(DualIAATransform):
        def __init__(self, *args, **kwargs):
            super().__init__(always_apply=kwargs.get('always_apply', False), 
                           p=kwargs.get('p', 0.5))
